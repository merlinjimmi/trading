    ...
    $("form#loginForm").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "success") {
                    $("#errorshow1").html("Login is successful. Redirecting to Dashboard... <span class='fas fa-1x fa-spinner fa-pulse'></span>").show();
                    setTimeout(' window.location.href = "./app/control"; ', 3000);
                }else{
